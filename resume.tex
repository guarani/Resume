...
\section{APP STORE}   
	...
	\begin{itemize}  \itemsep -2pt %reduce space between items
	    ...
	    \item Itau pagos - \ULurl{https://goo.gl/gfVveB}
	    \item Banco Familiar - \ULurl{https://goo.gl/yG2sFG}
	    \item BBVA Paraguay - \ULurl{https://goo.gl/kkevfK}
	    \item BBVA Business Paraguay - \ULurl{https://goo.gl/BfTVRu}
	    \item Financiera El Comercio - \ULurl{https://goo.gl/i1demZ}
	    \item Itau Paraguay - \ULurl{https://goo.gl/4Vh5il}
	\end{itemize}
