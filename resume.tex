...
\section{APP STORE}   
	...
	\begin{itemize}  \itemsep -2pt %reduce space between items
	    ...
	    \item\ULurl{https://goo.gl/gfVveB}
	    \item\ULurl{https://goo.gl/yG2sFG}
	    \item\ULurl{https://goo.gl/kkevfK}
	    \item\ULurl{https://goo.gl/BfTVRu}
	    \item\ULurl{https://goo.gl/i1demZ}
	    \item\ULurl{https://goo.gl/4Vh5il}
	\end{itemize}
